 ...
 *
 */
public class SolveRandomRestart {
	...
	SolveRandomRestart(QueensPuzzleNode myNode){
	...
	public void go(){
		...
		while ( this.isItSolved() == false){//restart loop
			
		//if the puzzle was unable to resolve with a heuristic cost of 0, the puzzle is reset.	
		QueensPuzzle restartPuzzle = new QueensPuzzle();
		this.current.setMyPuzzle(restartPuzzle);
